...
const EmptyState = () => (
  <div className="rounded-xl border-2 border-dashed border-slate-200 bg-slate-50 px-6 py-10 text-center dark:border-white/[0.06] dark:bg-white/[0.02]">
    <RouteIcon className="mx-auto h-8 w-8 text-slate-300 dark:text-gray-600" />
    <div className="mt-2 text-sm font-semibold text-slate-700 dark:text-gray-200">
      Sin rutas
    </div>
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="max-h-[420px] space-y-2 overflow-y-auto pr-1">
        {filtered.length === 0 ? (
          <div className="rounded-lg bg-slate-50 px-4 py-6 text-center text-xs text-slate-500 dark:bg-white/[0.03] dark:text-gray-400">
