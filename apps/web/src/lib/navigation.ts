...
export const navigationSections: NavigationSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "Tipos de aceite",
        href: "/gestion/tipos-aceite",
        icon: "TA",
        description: "Catalogo tecnico de lubricantes",
        accent: "sky",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        href: "/motores/nuevo",
        icon: "NM",
        description: "Alta tecnica y operativa",
        accent: "orange",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "Registro cambio de aceite",
        href: "/mantenimiento/cambios-aceite",
        icon: "CA",
        description: "Servicios de lubricacion por unidad",
        accent: "amber",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        href: "/checklist/categorias",
        icon: "CC",
        description: "Plantillas e items por tipo de inspeccion",
        accent: "lime",
      },
    ],
  },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: "RG",
        description: "Estado general de la operacion",
        accent: "cyan",
      },
      {
        label: "Vehiculos Asignados",
        href: "/reportes/vehiculos-asignados",
        icon: "VA",
        description: "Asignaciones entre conductores y vehiculos",
        accent: "cyan",
      },
      {
        label: "Gastos Realizados!",
        href: "/reportes/gastos-realizados",
        icon: "GR",
        description: "Costos de combustible y mantenimiento",
        accent: "cyan",
      },
      {
        label: "Reporte Checklist",
        href: "/reportes/checklist",
        icon: "RC",
        description: "Inspecciones y resultados",
        accent: "cyan",
      },
      {
        label: "Reporte Combustible",
        href: "/reportes/combustible",
        icon: "CB",
        description: "Cargas y rendimiento",
        accent: "cyan",
      },
      {
        label: "Alertas Enviados por Conductores",
        href: "/reportes/alertas-conductores",
        icon: "AC",
        description: "Seguimiento a novedades reportadas",
        accent: "cyan",
      },
      {
        label: "Reporte Inventarios",
        href: "/reportes/inventarios",
        icon: "RI",
        description: "Stock y movimientos de taller",
        accent: "cyan",
      },
      {
        label: "Reporte Generadores",
        href: "/reportes/generadores",
        icon: "GN",
        description: "Estado y mantenimientos de generadores",
        accent: "cyan",
      },
    ],
  },
